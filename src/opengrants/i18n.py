"""
Phase 1 Multilingual support for OpenGrants OS.
...
# Simple, high-signal expansions (can be replaced by proper embeddings later)
KEYWORD_EXPANSIONS: dict[str, list[str]] = {
    "open source": [
        "open source", "opensource", "open-source",
        "código abierto", "codigo abierto",
    ...
    "artificial intelligence": [
        "artificial intelligence", "ai", "machine learning", "ml", "llm",
        "inteligencia artificial", "apprentissage automatique",
        "apprentissage profond", "apprentissage machine",
        "人工知能", "人工智能", "인공지능",
    ],
    "public goods": [
        "public goods", "public-goods", "bienes públicos", "biens publics",
        "public interest", "interés público", "intérêt public",
        "commons", "digital public goods",
    ],
    "grant": [
        "grant", "grants", "funding", "subvention", "subvención",
        "förderung", "finanzierung", "bolsa", "edital",
    ],
}
